@extends('layouts.camille.includes.master')

@section('content')
    <section class="hero-wrap hero-wrap-2" style="background-image: url('camille/images/bg-el.jpg');" data-stellar-background-ratio="0.5">
                        ...
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch d-md-flex">
                                ...
                                <div class="text d-block pl-md-4">
                                    ...
                                    <div class="meta mb-3">
                                        <div><a href="#">{{$post->created_at->format('D, d M Y')}}</a></div>
